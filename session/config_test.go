...
func TestConfig_new(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			dsn:  "tgm://custom.session.com:9090?insecure=true&plaintext=true&request-keep-alive-delay=60s&default-max-request-per-user=50&indexer-api-key=server_abcdef123456",
			expect: &Config{
